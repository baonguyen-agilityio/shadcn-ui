...
export const Paragraph: Story = {
  args: {
    variant: 'p',
    children: 'This is paragraph text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
  },
}
...
export const AllVariants: Story = {
  render: () => (
    <div className="space-y-4 max-w-2xl">
      ...
      <Typography variant="large">Large: This is large text for emphasis</Typography>
